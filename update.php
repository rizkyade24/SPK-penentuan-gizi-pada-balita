...
if(isset($_POST['simpan'])){
    ...
    $sql="update `databalita` set NIK = '$NIK', nama_balita = '$nama_balita', tempat_lahir = '$tempat_lahir', jenis_kelamin = '$jenis_kelamin', alamat = '$alamat', ortu = '$ortu' where NIK=$NIK";
    $result = mysqli_query($koneksi,$sql);
    if($result){
        echo "sucess";
                                    ...
                                    <form class="user" action="" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="NIK" aria-describedby="emailHelp" value="<?php echo $NIK ?>" name="NIK"
                                                placeholder="Masukan NIK">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="nama_balita" value="<?php echo $nama_balita ?>" name="nama_balita" placeholder="Masukan nama balita">
                                        </div>
