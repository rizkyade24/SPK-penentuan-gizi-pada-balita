            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Kelola Data balita :</h6>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="https://play-lh.googleusercontent.com/FqQlvEGV5oKYJsQVcTMjB18v6CjFqBroVaGn8vFwKb8ws-zDEambLOixXCnCUseekg" alt="...">
                                    </div>
                                    ...
                                    <a target="_blank" rel="nofollow" href="https://www.lifebuoy.co.id/semua-artikel/berita-kesehatan/mengenal-stunting-penyebab-hingga-cara-pencegahannya.html">selengkapnya -></a>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Website resmi stunting pemerintah</h6>
                                </div>
                                <div class="card-body">
                                <iframe src="https://stunting.go.id/" height="500px" width="1200px"></iframe>
                                </div>
                            </div>
