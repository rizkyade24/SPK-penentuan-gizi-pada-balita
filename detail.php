...
$query    = mysqli_query($koneksi, "SELECT * FROM databalita WHERE NIK='$NIK' and periode=1");
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-5 xs-margin-30px-bottom">
                    ...
                    <div class="bg-light-gray padding-30px-all md-padding-25px-all sm-padding-20px-all text-center">
                        <h4 class="margin-10px-bottom font-size24 md-font-size22 sm-font-size20 font-weight-600" style="text-transform: uppercase;"><?php echo $result['nama_balita'] ?></h4>
